...
add wave -noupdate -color Magenta -label PC_Out -radix decimal /mips_multi_tb/i1/pc/sr_out
...
add wave -noupdate -label {Sign Extend} -radix decimal /mips_multi_tb/i1/sgnx/output
